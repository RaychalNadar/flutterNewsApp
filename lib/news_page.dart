...
import "package:news_app_mini_project/news_web_view.dart";
...
class _NewsPageState extends State<NewsPage> {
  ...
  Future<List<Article>> getNewsData() async{
    NewsAPI newsAPI = NewsAPI(apiKey: "232d16e1c35e421491048d0da214d403");
            ...
            child: ElevatedButton(
              ...
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all<Color>(
                  ...
                  Colors.green.withOpacity(0.5):Colors.green,
                )
              ),
